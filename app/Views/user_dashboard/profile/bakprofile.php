...
$userType = user_model(true)->select('user_type')->find(user('id'))->user_type ?? null;
$isUserStarter = $userType && $userType === UserTypes::STARTER;
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-2">
                        ...
                        <?= user_component('input', [
                            ...
                            'disabled' => $isUserStarter ? false : is_disable('full_name')
                        ]) ?>
                        ...
                        <?= user_component('input', [
                            ...
                            'disabled' => $isUserStarter ? false : is_disable('email')
                        ]) ?>
                        ...
                        <?= user_component('input', [
                            ...
                            'disabled' => $isUserStarter ? false : is_disable('phone')
                        ]) ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-2">
                        ...
                        <?= user_component('input', [
                            ...
                            'label' => 'Date of Birth',
                            'type' => 'date',
                            'value' => escape($ud->date_of_birth ?? ''),
                            'disabled' => is_disable('date_of_birth')
                        ]) ?>
                        ...
                        <?= user_component('select', [
                            ...
                            'select' => escape($ud->gender ?? ''),
                            'disabled' => is_disable('gender')
                        ]) ?>
                        ...
                        <?= user_component('input', [
                            ...
                            'value' => escape($ud->father_name ?? ''),
                            'disabled' => is_disable('father_name'),
                        ]) ?>
                        ...
                        <?= user_component('input', [
                            ...
                            'value' => escape($ud->mother_name ?? ''),
                            'disabled' => is_disable('mother_name')
                        ]) ?>
                        ...
                        <?= user_component('select', [
                            ...
                            'empty_option' => 'Select Employment Status',
                            'select' => escape($ud->employment_status ?? ''),
                            'disabled' => is_disable('employment_status')
                        ]) ?>
                        ...
                        <?= user_component('input', [
                            ...
                            'value' => escape($ud->occupation ?? ''),
                            'disabled' => is_disable('occupation')
                        ]) ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?= user_component('input', [
                            ...
                            'type' => 'number',
                            'value' => escape($ud->postal_code ?? ''),
                            'disabled' => is_disable('postal_code')
                        ]) ?>
                        ...
                        <?= user_component('input', [
                            ...
                            'value' => escape($ud->state ?? ''),
                            'disabled' => is_disable('state')
                        ]) ?>
                        ...
                        <?= user_component('input', [
                            ...
                            'value' => escape($ud->city ?? ''),
                            'disabled' => is_disable('city')
                        ]) ?>
                        ...
                        <?= user_component('textarea', [
                            ...
                            'value' => escape($ud->address ?? ''),
                            'disabled' => is_disable('address')
                        ]) ?>
                ...
                <div class="card mb-0">
                    ...
                    <div class="card-body">
                        ...
                        <?= user_component('input', [
                            ...
                            'value' => escape($ud->nominee ?? ''),
                            'disabled' => is_disable('nominee')
                        ]) ?>

                        <?= user_component('select', [
                            'name' => 'nominee_relation',
                            'label' => 'Nominee Relation',
                            'id' => 'nominee_relation_select',
                            'empty_option' => 'Select Nominee Relation',
                            'disabled' => is_disable('nominee_relation')
                        ]) ?>

                        <?= user_component('input', [
                            'name' => 'nominee_phone',
                            'label' => "Nominee Phone No",
                            'placeholder' => "Enter Nominee Phone No",
                            'value' => escape($ud->nominee_phone ?? ''),
                            'disabled' => is_disable('nominee_phone')
                        ]) ?>
                        ...
                        <?= user_component('input', [
                            ...
                            'value' => escape($ud->nominee_email ?? ''),
                            'disabled' => is_disable('nominee_email')
                        ]) ?>
                        ...
                        <?= user_component('textarea', [
                            ...
                            'value' => escape($ud->nominee_address ?? ''),
                            'disabled' => is_disable('nominee_address')
                        ]) ?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        const restricts = <?= json_encode($isUserStarter ? [] : \App\Twebsol\Settings::USER_PROFILE_UPDATE_RESTRICTIONS) ?>;
                    ...
                    success: function (res, textStatus, xhr) {
                        ...
                        if (xhr.status === 200) {
                            ...
                            if (res.profile_picture_url) {
                                $('.pfp_image_img').attr('src', res.profile_picture_url);
                                $('#imageUpload').val('');
                            }
                        }
