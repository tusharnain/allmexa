...
class CreateSponsorRoiLevelIncomesTable extends Migration
{
    const TABLE = 'sponsor_roi_level_incomes';
    ...
    public function up()
    {
        $this->forge->addField([
            ...
            'level' => Helper::int_attributes(type: 'TINYINT'), // tiny int coz, level should not be very higher, 1,2,3,4...9,10,11 max to max can go 40 or 50

            'level_user_id' => Helper::user_id_foreign_key_attributes(),

            'percent' => Helper::int_attributes(type: 'TINYINT', unsigned: true, null: true),
            'roi_bv' => [...Helper::default_amount_field_attributes(default: null), 'comment' => 'roi amount'],
