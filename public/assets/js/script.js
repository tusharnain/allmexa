(function ($) {
  ...
  (() => {
    ...
    if (mode) {
      $("body").addClass(mode == "dark-only" ? "dark-only" : "light");
      $("body").removeClass(mode == "dark-only" ? "light" : "dark-only");

      $(".mode").addClass(mode == "dark-only" ? "active" : " ");
      $(".mode").removeClass(mode == "dark-only" ? " " : "active");
    }
  })();
