function initThemeCustomizer(userAssetDir = null) {
  ...
  $(document).ready(function () {
    ...
    $(".customizer-contain .ti-close").on("click", function () {
